    ...
    <div className="home">
      <div className="home-inner">
        <div className="home-hero">
          ...
          {brain && !brain.claude.available && !brain.codex.available && !brain.local?.available && (
            <div className="brain-warning">
              No brain found. Use <b>Brain → Connect Claude account…</b> (or install Codex / a local
              model server). Slate uses your Claude Code session — no API keys.
            </div>
          )}
        </div>

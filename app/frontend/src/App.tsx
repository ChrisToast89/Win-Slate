...
export default function App(): React.JSX.Element {
  ...
  useEffect(() => {
    ...
    const offBrain = window.slate.onBrainRefresh
      ? window.slate.onBrainRefresh(() => {
          void refreshBrain()
        })
      : () => {}
    return () => {
    ...
    <div className="shell">
      <div className="titlebar">
        ...
        <div className="titlebar-side">
          ...
          <button className="btn btn-ghost btn-sm" title="Slate Help (Ctrl+/)" onClick={() => setHelpOpen(true)}>
            ?
          </button>
          {project && (
            <>
